...
#import "AMQuestion3ViewController.h"

@interface AMQuestion3ViewController () {
    NSArray *answers;
}

@end

@implementation AMQuestion3ViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    AMQuestion4ViewController *rvc = [segue destinationViewController];
